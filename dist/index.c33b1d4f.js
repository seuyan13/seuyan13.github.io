 ...
 */ !function(e, t) {
    ...
    var k = {
        slideTo: function(e, t, s, a, i) {
            ...
            const v = -o[g];
            if (r.updateProgress(v), l.normalizeSlideIndex) for(let e1 = 0; e1 < d.length; e1 += 1){
    ...
    var z = {
        loopCreate: function() {
            ...
            for(let e3 = 0; e3 < o.length; e3 += 1)r.append(d(o[e3].cloneNode(!0)).addClass(s.slideDuplicateClass));
            for(let e4 = l.length - 1; e4 >= 0; e4 -= 1)r.prepend(d(l[e4].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function() {
            const e = this;
...
//# sourceMappingURL=index.c33b1d4f.js.map
